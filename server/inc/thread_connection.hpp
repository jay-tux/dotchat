...
public:
  ...
  [[nodiscard]] inline bool is_running() const { return state == thread_state::RUNNING || state == thread_state::STOPPING; }
  inline void request_stop() { if(is_running()) state = thread_state::STOPPING; }
